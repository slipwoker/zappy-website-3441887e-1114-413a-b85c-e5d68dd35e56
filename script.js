document.addEventListener('DOMContentLoaded', function() {
        ...
        if (value) {
            ...
            if (field.hasAttribute('pattern')) {
                ...
                if (!pattern.test(value)) {
                    field.classList.add('error');
                    showError(field, field.getAttribute('data-error-message') || 'Invalid format');
                    return false;
                }
            }
        }
    ...
    function handleFormSubmit(event) {
        ...
        fields.forEach(field => {
            if (field.type !== 'submit' && field.type !== 'hidden' && field.type !== 'button') {
        ...
        if (isValid) {
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    successMessage.textContent = form.getAttribute('data-success-message') || 'Form submitted successfully!';
            ...
            .catch(error => {
                ...
                errorMessage.textContent = form.getAttribute('data-error-message') || 'An error occurred. Please try again.';
    ...
    function handleScrollAnimations() {
        ...
        animatedElements.forEach(element => {
            ...
            const triggerPoint = scrollPosition + windowHeight * 0.85;

            if (triggerPoint > elementTop && scrollPosition < elementBottom) {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('blur', function(event) {
            const field = event.target.closest('input, textarea, select');
            if (field && field.type !== 'submit' && field.type !== 'button' && field.value.trim()) {
                validateField(field);
            }
        }, true);
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3441887e-1114-413a-b85c-e5d68dd35e56',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3441887e-1114-413a-b85c-e5d68dd35e56';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3441887e-1114-413a-b85c-e5d68dd35e56';
